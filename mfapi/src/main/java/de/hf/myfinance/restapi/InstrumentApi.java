...
public interface InstrumentApi {
	...
	@GetMapping(value = "/securities", produces = "application/json")
	Flux<Instrument> listSecurities();
	...
	Flux<Instrument> listAllAccounts(@RequestParam String tenantbusinesskey);
