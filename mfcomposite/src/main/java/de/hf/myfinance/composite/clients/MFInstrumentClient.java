...
public class MFInstrumentClient implements InstrumentApi {
    ...
    public Flux<Instrument> listSecurities() {
        return webClient.get().uri(instrumentServiceUrl + "/securities")
                .retrieve().bodyToFlux(Instrument.class);
    }
    ...
    public Flux<Instrument> listAllAccounts(String tenantbusinesskey) {
        return webClient.get().uri(instrumentServiceUrl + "/allaccounts?tenantbusinesskey="
        + tenantbusinesskey)
        .retrieve().bodyToFlux(Instrument.class);
    }
    ...
    public Flux<Instrument> listAllBudgets(String tenantbusinesskey) {
        return webClient.get().uri(instrumentServiceUrl + "/allbudgets?tenantbusinesskey="
        + tenantbusinesskey)
        .retrieve().bodyToFlux(Instrument.class);
    }
